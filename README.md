...
It will also create a .TRASH directory in your home directory, and will enable you to use the aliases and functions from this repository's ./etc/bashrc_custom file by linking it at the end of your home directory's .bashrc file.
Note that this script will only run on linux.
##./bin/cleanup.sh
This file will remove your home directory's .vimrc file, the .TRASH directory created by the linux.sh script, and will unlink the bashrc_custom from you .bashrc file.
It effectively undoes the changes made by the linux.sh script (note that your backup .vimrc file will still be named .bup_vimrc).
##./Makefile
